...
- Keep inspection passive. Do not add port scanning, vulnerability scanning, access-control bypasses, telemetry, or a central data store. A stateless Slack command receiver is allowed when it stores no targets or reports.
